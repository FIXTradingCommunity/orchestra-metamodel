...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Volume T</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see io.fixprotocol._2016.fixrepository.FixrepositoryPackage#getVolumeT()
 * @model extendedMetaData="name='Volume_t'"
 * @generated
 */
public enum VolumeT implements Enumerator {
  /**
  ...
  /**
	 * The '<em><b>FIXT11</b></em>' literal object.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @see #FIXT11_VALUE
	 * @generated
  ...
  /**
	 * The '<em><b>FIXT11</b></em>' literal value.
	 * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>FIXT11</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
	 * @see #FIXT11
	 * @model literal="FIXT.1.1"
	 * @generated
	 * @ordered
	 */
  public static final int FIXT11_VALUE = 6;
  ...
  /**
	...
	public static final int _7_VALUE = 7;
		...
		/**
	 * An array of all the '<em><b>Volume T</b></em>' enumerators.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  private static final VolumeT[] VALUES_ARRAY =
    new VolumeT[] {
			_1,
			_2,
			_3,
  ...
  /**
	 * A public read-only list of all the '<em><b>Volume T</b></em>' enumerators.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  public static final List<VolumeT> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
	 * Returns the '<em><b>Volume T</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public static VolumeT get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			VolumeT result = VALUES_ARRAY[i];
  ...
  /**
	 * Returns the '<em><b>Volume T</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
  public static VolumeT getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			VolumeT result = VALUES_ARRAY[i];
  ...
  /**
	 * Returns the '<em><b>Volume T</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  public static VolumeT get(int value) {
		switch (value) {
			...
			case FIXT11_VALUE: return FIXT11;
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  private VolumeT(int value, String name, String literal) {
		this.value = value;
		this.name = name;
