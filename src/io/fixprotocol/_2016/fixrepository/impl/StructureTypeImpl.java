 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.StructureTypeImpl#getWhich <em>Which</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureTypeImpl extends MinimalEObjectImpl.Container implements StructureType {
  ...
  public void setWhich(MemberType newWhich) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.STRUCTURE_TYPE__WHICH, oldWhich, which, !oldWhichESet));
  }
  ...
  public void unsetWhich() {
    ...
    whichESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.STRUCTURE_TYPE__WHICH, oldWhich, WHICH_EDEFAULT, oldWhichESet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.STRUCTURE_TYPE__FIELD_REF:
        return getFieldRef();
      case FixrepositoryPackage.STRUCTURE_TYPE__WHICH:
        return getWhich();
    }
