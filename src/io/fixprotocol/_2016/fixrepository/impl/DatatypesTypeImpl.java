 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypesTypeImpl#getBase <em>Base</em>}</li>
...
public class DatatypesTypeImpl extends MinimalEObjectImpl.Container implements DatatypesType {
  ...
  public void setBase(String newBase) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPES_TYPE__BASE, oldBase, base));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case FixrepositoryPackage.DATATYPES_TYPE__DATATYPE:
        return getDatatype();
      case FixrepositoryPackage.DATATYPES_TYPE__BASE:
        return getBase();
