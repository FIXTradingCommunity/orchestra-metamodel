 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getAbbrName <em>Abbr Name</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getAdded <em>Added</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getAddedEP <em>Added EP</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getChangeType <em>Change Type</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getDeprecated <em>Deprecated</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getDeprecatedEP <em>Deprecated EP</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getIssue <em>Issue</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getLastModified <em>Last Modified</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getReplaced <em>Replaced</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getReplacedByField <em>Replaced By Field</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getReplacedEP <em>Replaced EP</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getScenario <em>Scenario</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getSpecUrl <em>Spec Url</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getSupported <em>Supported</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getUpdated <em>Updated</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getUpdatedEP <em>Updated EP</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CodeSetTypeImpl extends MinimalEObjectImpl.Container implements CodeSetType {
  ...
  protected EClass eStaticClass() {
    return FixrepositoryPackage.eINSTANCE.getCodeSetType();
  }
  ...
  @Override
    ...
    if (code == null) {
      code = new EObjectContainmentEList<CodeType>(CodeType.class, this, FixrepositoryPackage.CODE_SET_TYPE__CODE);
    }
    return code;
  }
  ...
  public NotificationChain basicSetAnnotation(Annotation newAnnotation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__ANNOTATION, oldAnnotation, newAnnotation);
  ...
  @Override
    ...
    if (newAnnotation != annotation) {
      ...
      if (annotation != null)
        msgs = ((InternalEObject)annotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FixrepositoryPackage.CODE_SET_TYPE__ANNOTATION, null, msgs);
      if (newAnnotation != null)
        msgs = ((InternalEObject)newAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FixrepositoryPackage.CODE_SET_TYPE__ANNOTATION, null, msgs);
      msgs = basicSetAnnotation(newAnnotation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__ANNOTATION, newAnnotation, newAnnotation));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__ABBR_NAME, oldAbbrName, abbrName));
  }
  ...
  @Override
    ...
    added = newAdded;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__ADDED, oldAdded, added));
  }
  ...
  @Override
    ...
    addedEP = newAddedEP;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__ADDED_EP, oldAddedEP, addedEP));
  }
  ...
  @Override
    ...
    changeTypeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__CHANGE_TYPE, oldChangeType, changeType, !oldChangeTypeESet));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.CODE_SET_TYPE__CHANGE_TYPE, oldChangeType, CHANGE_TYPE_EDEFAULT, oldChangeTypeESet));
  }
  ...
  @Override
    ...
    default_ = newDefault;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__DEFAULT, oldDefault, default_));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__DEPRECATED, oldDeprecated, deprecated));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__DEPRECATED_EP, oldDeprecatedEP, deprecatedEP));
  }
  ...
  @Override
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__ID, oldId, id));
  }
  ...
  @Override
    ...
    issue = newIssue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__ISSUE, oldIssue, issue));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__LAST_MODIFIED, oldLastModified, lastModified));
  }
  ...
  @Override
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__NAME, oldName, name));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__REPLACED, oldReplaced, replaced));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__REPLACED_BY_FIELD, oldReplacedByField, replacedByField));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__REPLACED_EP, oldReplacedEP, replacedEP));
  }
   ...
   */
    ...
    scenarioESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__SCENARIO, oldScenario, scenario, !oldScenarioESet));
  }
   ...
   */
    ...
    scenarioESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.CODE_SET_TYPE__SCENARIO, oldScenario, SCENARIO_EDEFAULT, oldScenarioESet));
  }
  ...
  @Override
    ...
    specUrl = newSpecUrl;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__SPEC_URL, oldSpecUrl, specUrl));
  }
  ...
  @Override
    ...
    supportedESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__SUPPORTED, oldSupported, supported, !oldSupportedESet));
  }
  ...
  @Override
    ...
    supportedESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.CODE_SET_TYPE__SUPPORTED, oldSupported, SUPPORTED_EDEFAULT, oldSupportedESet));
  }
  ...
  @Override
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__TYPE, oldType, type));
  }
  ...
  @Override
    ...
    updated = newUpdated;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__UPDATED, oldUpdated, updated));
  }
  ...
  @Override
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__UPDATED_EP, oldUpdatedEP, updatedEP));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case FixrepositoryPackage.CODE_SET_TYPE__CODE:
        return ((InternalEList<?>)getCode()).basicRemove(otherEnd, msgs);
      case FixrepositoryPackage.CODE_SET_TYPE__ANNOTATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.CODE_SET_TYPE__ABBR_NAME:
        return getAbbrName();
      case FixrepositoryPackage.CODE_SET_TYPE__ADDED:
        return getAdded();
      case FixrepositoryPackage.CODE_SET_TYPE__ADDED_EP:
        return getAddedEP();
      case FixrepositoryPackage.CODE_SET_TYPE__CHANGE_TYPE:
        return getChangeType();
      case FixrepositoryPackage.CODE_SET_TYPE__DEFAULT:
        return getDefault();
      case FixrepositoryPackage.CODE_SET_TYPE__DEPRECATED:
        return getDeprecated();
      case FixrepositoryPackage.CODE_SET_TYPE__DEPRECATED_EP:
        return getDeprecatedEP();
      case FixrepositoryPackage.CODE_SET_TYPE__ID:
        return getId();
      case FixrepositoryPackage.CODE_SET_TYPE__ISSUE:
        return getIssue();
      case FixrepositoryPackage.CODE_SET_TYPE__LAST_MODIFIED:
        return getLastModified();
      case FixrepositoryPackage.CODE_SET_TYPE__NAME:
        return getName();
      case FixrepositoryPackage.CODE_SET_TYPE__REPLACED:
        return getReplaced();
      case FixrepositoryPackage.CODE_SET_TYPE__REPLACED_BY_FIELD:
        return getReplacedByField();
      case FixrepositoryPackage.CODE_SET_TYPE__REPLACED_EP:
        return getReplacedEP();
      case FixrepositoryPackage.CODE_SET_TYPE__SCENARIO:
        return getScenario();
      case FixrepositoryPackage.CODE_SET_TYPE__SPEC_URL:
        return getSpecUrl();
      case FixrepositoryPackage.CODE_SET_TYPE__SUPPORTED:
        return getSupported();
      case FixrepositoryPackage.CODE_SET_TYPE__TYPE:
        return getType();
      case FixrepositoryPackage.CODE_SET_TYPE__UPDATED:
        return getUpdated();
      case FixrepositoryPackage.CODE_SET_TYPE__UPDATED_EP:
        return getUpdatedEP();
    }
