 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeSetTypeImpl#getOid <em>Oid</em>}</li>
...
public class CodeSetTypeImpl extends MinimalEObjectImpl.Container implements CodeSetType {
  ...
  public void setOid(String newOid) {
    ...
    oid = newOid;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_SET_TYPE__OID, oldOid, oid));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.CODE_SET_TYPE__NAME:
        return getName();
      case FixrepositoryPackage.CODE_SET_TYPE__OID:
        return getOid();
