 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.ActorsTypeImpl#getBase <em>Base</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActorsTypeImpl extends MinimalEObjectImpl.Container implements ActorsType {
  ...
  public void setBase(String newBase) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.ACTORS_TYPE__BASE, oldBase, base));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.ACTORS_TYPE__FLOW:
        return getFlow();
      case FixrepositoryPackage.ACTORS_TYPE__BASE:
        return getBase();
    }
