 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.ComponentTypeImpl#getWhich <em>Which</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentTypeImpl extends MinimalEObjectImpl.Container implements ComponentType {
  ...
  public void setWhich(MemberType newWhich) {
    ...
    whichESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.COMPONENT_TYPE__WHICH, oldWhich, which, !oldWhichESet));
  }
  ...
  public void unsetWhich() {
    ...
    whichESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.COMPONENT_TYPE__WHICH, oldWhich, WHICH_EDEFAULT, oldWhichESet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.COMPONENT_TYPE__UPDATED_EP:
        return getUpdatedEP();
      case FixrepositoryPackage.COMPONENT_TYPE__WHICH:
        return getWhich();
    }
