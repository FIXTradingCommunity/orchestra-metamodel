 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.RepositoryTypeImpl#isHasComponents <em>Has Components</em>}</li>
...
public class RepositoryTypeImpl extends MinimalEObjectImpl.Container implements RepositoryType {
  ...
  /**
   * The default value of the '{@link #isHasComponents() <em>Has Components</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isHasComponents()
   * @generated
   * @ordered
   */
  protected static final boolean HAS_COMPONENTS_EDEFAULT = false;

  /**
   * The cached value of the '{@link #isHasComponents() <em>Has Components</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isHasComponents()
   * @generated
   * @ordered
   */
  protected boolean hasComponents = HAS_COMPONENTS_EDEFAULT;

  /**
   * This is true if the Has Components attribute has been set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  protected boolean hasComponentsESet;
   ...
   * @generated
   */
  public void setHasComponents(boolean newHasComponents) {
    boolean oldHasComponents = hasComponents;
    hasComponents = newHasComponents;
    boolean oldHasComponentsESet = hasComponentsESet;
    hasComponentsESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.REPOSITORY_TYPE__HAS_COMPONENTS, oldHasComponents, hasComponents, !oldHasComponentsESet));
  }
  ...
  public void unsetHasComponents() {
    boolean oldHasComponents = hasComponents;
    boolean oldHasComponentsESet = hasComponentsESet;
    hasComponents = HAS_COMPONENTS_EDEFAULT;
    hasComponentsESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.REPOSITORY_TYPE__HAS_COMPONENTS, oldHasComponents, HAS_COMPONENTS_EDEFAULT, oldHasComponentsESet));
  }
   ...
   * @generated
   */
  public boolean isSetHasComponents() {
    return hasComponentsESet;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.REPOSITORY_TYPE__GUID:
        return getGuid();
      case FixrepositoryPackage.REPOSITORY_TYPE__HAS_COMPONENTS:
        return isHasComponents();
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.REPOSITORY_TYPE__GUID:
        ...
        return;
      case FixrepositoryPackage.REPOSITORY_TYPE__HAS_COMPONENTS:
        setHasComponents((Boolean)newValue);
        return;
      case FixrepositoryPackage.REPOSITORY_TYPE__LATEST_EP:
  ...
  public String toString() {
    ...
    if (hasComponentsESet) result.append(hasComponents); else result.append("<unset>");
