...
public class FixrepositoryFactoryImpl extends EFactoryImpl implements FixrepositoryFactory {
  ...
  public EObject create(EClass eClass) {
    switch (eClass.getClassifierID()) {
      case FixrepositoryPackage.ABBREVIATIONS_TYPE: return createAbbreviationsType();
      case FixrepositoryPackage.ABBREVIATION_TYPE: return createAbbreviationType();
  ...
  public Object createFromString(EDataType eDataType, String initialValue) {
    switch (eDataType.getClassifierID()) {
      ...
      case FixrepositoryPackage.SECTION_IDT:
        return createSectionIDTFromString(eDataType, initialValue);
      ...
      case FixrepositoryPackage.VOLUME_NAME_T:
        return createVolumeNameTFromString(eDataType, initialValue);
      case FixrepositoryPackage.VOLUME_T:
        return createVolumeTFromString(eDataType, initialValue);
      ...
      case FixrepositoryPackage.CATEGORY_IDT:
        return createCategoryIDTFromString(eDataType, initialValue);
      ...
      case FixrepositoryPackage.OID_OR_URI_T:
        return createOidOrUriTFromString(eDataType, initialValue);
      case FixrepositoryPackage.OID_T:
        return createOidTFromString(eDataType, initialValue);
      ...
      case FixrepositoryPackage.SECTION_IDT_OBJECT:
        return createSectionIDTObjectFromString(eDataType, initialValue);
      ...
      case FixrepositoryPackage.VOLUME_NAME_TOBJECT:
        return createVolumeNameTObjectFromString(eDataType, initialValue);
      case FixrepositoryPackage.VOLUME_NUMBER_T:
        return createVolumeNumberTFromString(eDataType, initialValue);
      case FixrepositoryPackage.VOLUME_TOBJECT:
        return createVolumeTObjectFromString(eDataType, initialValue);
      default:
  ...
  public String convertToString(EDataType eDataType, Object instanceValue) {
    switch (eDataType.getClassifierID()) {
      ...
      case FixrepositoryPackage.SECTION_IDT:
        return convertSectionIDTToString(eDataType, instanceValue);
      case FixrepositoryPackage.SUPPORT_TYPE:
      ...
      case FixrepositoryPackage.VOLUME_NAME_T:
        return convertVolumeNameTToString(eDataType, instanceValue);
      case FixrepositoryPackage.VOLUME_T:
        return convertVolumeTToString(eDataType, instanceValue);
      case FixrepositoryPackage.ABBREVIATION_T:
      ...
      case FixrepositoryPackage.CATEGORY_IDT:
        return convertCategoryIDTToString(eDataType, instanceValue);
      case FixrepositoryPackage.CAT_INCLUDE_FILE_TOBJECT:
      ...
      case FixrepositoryPackage.OID_OR_URI_T:
        return convertOidOrUriTToString(eDataType, instanceValue);
      case FixrepositoryPackage.OID_T:
        return convertOidTToString(eDataType, instanceValue);
      case FixrepositoryPackage.PRESENCE_TOBJECT:
      ...
      case FixrepositoryPackage.SECTION_IDT_OBJECT:
        return convertSectionIDTObjectToString(eDataType, instanceValue);
      case FixrepositoryPackage.SORT_T:
      ...
      case FixrepositoryPackage.VOLUME_NAME_TOBJECT:
        return convertVolumeNameTObjectToString(eDataType, instanceValue);
      case FixrepositoryPackage.VOLUME_NUMBER_T:
        return convertVolumeNumberTToString(eDataType, instanceValue);
      case FixrepositoryPackage.VOLUME_TOBJECT:
        return convertVolumeTObjectToString(eDataType, instanceValue);
      default:
        throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
    }
  }
   ...
   * @generated
   */
  public AbbreviationsType createAbbreviationsType() {
    AbbreviationsTypeImpl abbreviationsType = new AbbreviationsTypeImpl();
    return abbreviationsType;
  }
   ...
   * @generated
   */
  public SectionIDT createSectionIDTFromString(EDataType eDataType, String initialValue) {
    SectionIDT result = SectionIDT.get(initialValue);
    if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
    return result;
  }
   ...
   * @generated
   */
  public String convertSectionIDTToString(EDataType eDataType, Object instanceValue) {
    return instanceValue == null ? null : instanceValue.toString();
  }
   ...
   * @generated
   */
  public VolumeNameT createVolumeNameTFromString(EDataType eDataType, String initialValue) {
    VolumeNameT result = VolumeNameT.get(initialValue);
    if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
    return result;
  }
   ...
   * @generated
   */
  public String convertVolumeNameTToString(EDataType eDataType, Object instanceValue) {
    return instanceValue == null ? null : instanceValue.toString();
  }
   ...
   * @generated
   */
  public VolumeT createVolumeTFromString(EDataType eDataType, String initialValue) {
    VolumeT result = VolumeT.get(initialValue);
    if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
    return result;
  }
   ...
   * @generated
   */
  public String convertVolumeTToString(EDataType eDataType, Object instanceValue) {
    return instanceValue == null ? null : instanceValue.toString();
  }
   ...
   * @generated
   */
  public String createCategoryIDTFromString(EDataType eDataType, String initialValue) {
   ...
   * @generated
   */
  public String convertCategoryIDTToString(EDataType eDataType, Object instanceValue) {
   ...
   * @generated
   */
  public String createOidOrUriTFromString(EDataType eDataType, String initialValue) {
    if (initialValue == null) return null;
    String result = null;
    RuntimeException exception = null;
    try {
    ...
    try {
      result = createOidTFromString(FixrepositoryPackage.eINSTANCE.getOidT(), initialValue);
      if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
        return result;
      }
    }
   ...
   * @generated
   */
  public String convertOidOrUriTToString(EDataType eDataType, Object instanceValue) {
    if (instanceValue == null) return null;
    ...
    if (FixrepositoryPackage.eINSTANCE.getOidT().isInstance(instanceValue)) {
      try {
        String value = convertOidTToString(FixrepositoryPackage.eINSTANCE.getOidT(), instanceValue);
        if (value != null) return value;
      }
      catch (Exception e) {
        // Keep trying other member types until all have failed.
   ...
   * @generated
   */
  public String createOidTFromString(EDataType eDataType, String initialValue) {
    return (String)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.Literals.STRING, initialValue);
  }
   ...
   * @generated
   */
  public String convertOidTToString(EDataType eDataType, Object instanceValue) {
    return XMLTypeFactory.eINSTANCE.convertToString(XMLTypePackage.Literals.STRING, instanceValue);
  }
   ...
   * @generated
   */
  public SectionIDT createSectionIDTObjectFromString(EDataType eDataType, String initialValue) {
    return createSectionIDTFromString(FixrepositoryPackage.eINSTANCE.getSectionIDT(), initialValue);
  }
   ...
   * @generated
   */
  public String convertSectionIDTObjectToString(EDataType eDataType, Object instanceValue) {
    return convertSectionIDTToString(FixrepositoryPackage.eINSTANCE.getSectionIDT(), instanceValue);
  }
   ...
   * @generated
   */
  public VolumeNameT createVolumeNameTObjectFromString(EDataType eDataType, String initialValue) {
    return createVolumeNameTFromString(FixrepositoryPackage.eINSTANCE.getVolumeNameT(), initialValue);
  }
   ...
   * @generated
   */
  public String convertVolumeNameTObjectToString(EDataType eDataType, Object instanceValue) {
    return convertVolumeNameTToString(FixrepositoryPackage.eINSTANCE.getVolumeNameT(), instanceValue);
  }
   ...
   * @generated
   */
  public BigInteger createVolumeNumberTFromString(EDataType eDataType, String initialValue) {
    return (BigInteger)XMLTypeFactory.eINSTANCE.createFromString(XMLTypePackage.Literals.NON_NEGATIVE_INTEGER, initialValue);
  }
   ...
   * @generated
   */
  public String convertVolumeNumberTToString(EDataType eDataType, Object instanceValue) {
    return XMLTypeFactory.eINSTANCE.convertToString(XMLTypePackage.Literals.NON_NEGATIVE_INTEGER, instanceValue);
  }
   ...
   * @generated
   */
  public VolumeT createVolumeTObjectFromString(EDataType eDataType, String initialValue) {
    return createVolumeTFromString(FixrepositoryPackage.eINSTANCE.getVolumeT(), initialValue);
  }
   ...
   * @generated
   */
  public String convertVolumeTObjectToString(EDataType eDataType, Object instanceValue) {
    return convertVolumeTToString(FixrepositoryPackage.eINSTANCE.getVolumeT(), instanceValue);
  }
