 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.MessageRefTypeImpl#getIdentifiers <em>Identifiers</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.MessageRefTypeImpl#getId <em>Id</em>}</li>
...
public class MessageRefTypeImpl extends MinimalEObjectImpl.Container implements MessageRefType {
  ...
  /**
	...
	public NotificationChain basicSetIdentifiers(IdentifiersType newIdentifiers, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.MESSAGE_REF_TYPE__IDENTIFIERS, oldIdentifiers, newIdentifiers);
	...
	public void setIdentifiers(IdentifiersType newIdentifiers) {
		if (newIdentifiers != identifiers) {
			...
			if (identifiers != null)
				msgs = ((InternalEObject)identifiers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FixrepositoryPackage.MESSAGE_REF_TYPE__IDENTIFIERS, null, msgs);
			if (newIdentifiers != null)
				msgs = ((InternalEObject)newIdentifiers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FixrepositoryPackage.MESSAGE_REF_TYPE__IDENTIFIERS, null, msgs);
			msgs = basicSetIdentifiers(newIdentifiers, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.MESSAGE_REF_TYPE__IDENTIFIERS, newIdentifiers, newIdentifiers));
	}
	...
	public void setId(BigInteger newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.MESSAGE_REF_TYPE__ID, oldId, id));
	}
  ...
  /**
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FixrepositoryPackage.MESSAGE_REF_TYPE__IDENTIFIERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FixrepositoryPackage.MESSAGE_REF_TYPE__ID:
				return getId();
