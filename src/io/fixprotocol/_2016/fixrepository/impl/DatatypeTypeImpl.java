 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getMappedDatatype <em>Mapped Datatype</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getAdded <em>Added</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getAddedEP <em>Added EP</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getBaseType <em>Base Type</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getChangeType <em>Change Type</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getDeprecated <em>Deprecated</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getDeprecatedEP <em>Deprecated EP</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getIssue <em>Issue</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getLastModified <em>Last Modified</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getReplaced <em>Replaced</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getReplacedByField <em>Replaced By Field</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getReplacedEP <em>Replaced EP</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getSupported <em>Supported</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getUpdated <em>Updated</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.DatatypeTypeImpl#getUpdatedEP <em>Updated EP</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatatypeTypeImpl extends MinimalEObjectImpl.Container implements DatatypeType {
  ...
  protected EClass eStaticClass() {
    return FixrepositoryPackage.eINSTANCE.getDatatypeType();
  }
  ...
  public EList<MappedDatatypeType> getMappedDatatype() {
    if (mappedDatatype == null) {
      mappedDatatype = new EObjectContainmentEList<MappedDatatypeType>(MappedDatatypeType.class, this, FixrepositoryPackage.DATATYPE_TYPE__MAPPED_DATATYPE);
    }
  ...
  public NotificationChain basicSetAnnotation(Annotation newAnnotation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__ANNOTATION, oldAnnotation, newAnnotation);
  ...
  public void setAnnotation(Annotation newAnnotation) {
    if (newAnnotation != annotation) {
      ...
      if (annotation != null)
        msgs = ((InternalEObject)annotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FixrepositoryPackage.DATATYPE_TYPE__ANNOTATION, null, msgs);
      if (newAnnotation != null)
        msgs = ((InternalEObject)newAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FixrepositoryPackage.DATATYPE_TYPE__ANNOTATION, null, msgs);
      msgs = basicSetAnnotation(newAnnotation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__ANNOTATION, newAnnotation, newAnnotation));
  }
  ...
  public void setAdded(String newAdded) {
    ...
    added = newAdded;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__ADDED, oldAdded, added));
  }
  ...
  public void setAddedEP(BigInteger newAddedEP) {
    ...
    addedEP = newAddedEP;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__ADDED_EP, oldAddedEP, addedEP));
  }
  ...
  public void setBaseType(String newBaseType) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__BASE_TYPE, oldBaseType, baseType));
  }
  ...
  public void setChangeType(ChangeTypeT newChangeType) {
    ...
    changeTypeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__CHANGE_TYPE, oldChangeType, changeType, !oldChangeTypeESet));
  }
  ...
  public void unsetChangeType() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.DATATYPE_TYPE__CHANGE_TYPE, oldChangeType, CHANGE_TYPE_EDEFAULT, oldChangeTypeESet));
  }
  ...
  public void setDeprecated(String newDeprecated) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__DEPRECATED, oldDeprecated, deprecated));
  }
  ...
  public void setDeprecatedEP(BigInteger newDeprecatedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__DEPRECATED_EP, oldDeprecatedEP, deprecatedEP));
  }
  ...
  public void setIssue(String newIssue) {
    ...
    issue = newIssue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__ISSUE, oldIssue, issue));
  }
  ...
  public void setLastModified(String newLastModified) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__LAST_MODIFIED, oldLastModified, lastModified));
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__NAME, oldName, name));
  }
  ...
  public void setReplaced(String newReplaced) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__REPLACED, oldReplaced, replaced));
  }
  ...
  public void setReplacedByField(BigInteger newReplacedByField) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__REPLACED_BY_FIELD, oldReplacedByField, replacedByField));
  }
  ...
  public void setReplacedEP(BigInteger newReplacedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__REPLACED_EP, oldReplacedEP, replacedEP));
  }
  ...
  public void setSupported(SupportType newSupported) {
    ...
    supportedESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__SUPPORTED, oldSupported, supported, !oldSupportedESet));
  }
  ...
  public void unsetSupported() {
    ...
    supportedESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.DATATYPE_TYPE__SUPPORTED, oldSupported, SUPPORTED_EDEFAULT, oldSupportedESet));
  }
  ...
  public void setUpdated(String newUpdated) {
    ...
    updated = newUpdated;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__UPDATED, oldUpdated, updated));
  }
  ...
  public void setUpdatedEP(BigInteger newUpdatedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.DATATYPE_TYPE__UPDATED_EP, oldUpdatedEP, updatedEP));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case FixrepositoryPackage.DATATYPE_TYPE__MAPPED_DATATYPE:
        return ((InternalEList<?>)getMappedDatatype()).basicRemove(otherEnd, msgs);
      case FixrepositoryPackage.DATATYPE_TYPE__ANNOTATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.DATATYPE_TYPE__ADDED:
        return getAdded();
      case FixrepositoryPackage.DATATYPE_TYPE__ADDED_EP:
        return getAddedEP();
      case FixrepositoryPackage.DATATYPE_TYPE__BASE_TYPE:
        return getBaseType();
      case FixrepositoryPackage.DATATYPE_TYPE__CHANGE_TYPE:
        return getChangeType();
      case FixrepositoryPackage.DATATYPE_TYPE__DEPRECATED:
        return getDeprecated();
      case FixrepositoryPackage.DATATYPE_TYPE__DEPRECATED_EP:
        return getDeprecatedEP();
      case FixrepositoryPackage.DATATYPE_TYPE__ISSUE:
        return getIssue();
      case FixrepositoryPackage.DATATYPE_TYPE__LAST_MODIFIED:
        return getLastModified();
      case FixrepositoryPackage.DATATYPE_TYPE__NAME:
        return getName();
      case FixrepositoryPackage.DATATYPE_TYPE__REPLACED:
        return getReplaced();
      case FixrepositoryPackage.DATATYPE_TYPE__REPLACED_BY_FIELD:
        return getReplacedByField();
      case FixrepositoryPackage.DATATYPE_TYPE__REPLACED_EP:
        return getReplacedEP();
      case FixrepositoryPackage.DATATYPE_TYPE__SUPPORTED:
        return getSupported();
      case FixrepositoryPackage.DATATYPE_TYPE__UPDATED:
        return getUpdated();
      case FixrepositoryPackage.DATATYPE_TYPE__UPDATED_EP:
        return getUpdatedEP();
    }
