 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CodeTypeImpl#getOid <em>Oid</em>}</li>
...
public class CodeTypeImpl extends MinimalEObjectImpl.Container implements CodeType {
  ...
  public void setOid(String newOid) {
    ...
    oid = newOid;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CODE_TYPE__OID, oldOid, oid));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.CODE_TYPE__NAME:
        return getName();
      case FixrepositoryPackage.CODE_TYPE__OID:
        return getOid();
