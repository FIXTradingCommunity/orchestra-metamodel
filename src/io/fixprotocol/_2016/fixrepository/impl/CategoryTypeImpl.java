 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.CategoryTypeImpl#getName <em>Name</em>}</li>
...
public class CategoryTypeImpl extends MinimalEObjectImpl.Container implements CategoryType {
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CATEGORY_TYPE__NAME, oldName, name));
  }
  ...
  public void setSection(String newSection) {
    ...
    section = newSection;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.CATEGORY_TYPE__SECTION, oldSection, section));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.CATEGORY_TYPE__NAME:
        return getName();
