 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.MessagesTypeImpl#getBase <em>Base</em>}</li>
...
public class MessagesTypeImpl extends MinimalEObjectImpl.Container implements MessagesType {
  ...
  public void setBase(String newBase) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.MESSAGES_TYPE__BASE, oldBase, base));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case FixrepositoryPackage.MESSAGES_TYPE__MESSAGE:
        return getMessage();
      case FixrepositoryPackage.MESSAGES_TYPE__BASE:
        return getBase();
