 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.FieldTypeImpl#getScenario <em>Scenario</em>}</li>
...
public class FieldTypeImpl extends MinimalEObjectImpl.Container implements FieldType {
   ...
   */
    ...
    scenarioESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.FIELD_TYPE__SCENARIO, oldScenario, scenario, !oldScenarioESet));
  }
   ...
   */
    ...
    scenarioESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, FixrepositoryPackage.FIELD_TYPE__SCENARIO, oldScenario, SCENARIO_EDEFAULT, oldScenarioESet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case FixrepositoryPackage.FIELD_TYPE__SCENARIO:
        return getScenario();
