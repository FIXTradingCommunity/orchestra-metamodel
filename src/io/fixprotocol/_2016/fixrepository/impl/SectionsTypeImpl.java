 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.impl.SectionsTypeImpl#getBase <em>Base</em>}</li>
...
public class SectionsTypeImpl extends MinimalEObjectImpl.Container implements SectionsType {
  ...
  public void setBase(String newBase) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FixrepositoryPackage.SECTIONS_TYPE__BASE, oldBase, base));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case FixrepositoryPackage.SECTIONS_TYPE__SECTION:
        return getSection();
      case FixrepositoryPackage.SECTIONS_TYPE__BASE:
        return getBase();
