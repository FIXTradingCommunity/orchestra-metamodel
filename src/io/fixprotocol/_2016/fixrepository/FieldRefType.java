 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2016.fixrepository.FieldRefType#getCodeSet <em>Code Set</em>}</li>
 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.FieldRefType#getAbbrName <em>Abbr Name</em>}</li>
 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.FieldRefType#getName <em>Name</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.FieldRefType#getOid <em>Oid</em>}</li>
...
public interface FieldRefType extends EObject {
  /**
   * Returns the value of the '<em><b>Code Set</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * CodeSet may be specified inline or referenced by
   * 						type attribute, but not both. Not currently enforced by this
   * 						schema.
   * 						Consider XML schema assertion in future.
   * 					
   * <!-- end-model-doc -->
   * @return the value of the '<em>Code Set</em>' containment reference.
   * @see #setCodeSet(CodeSetType)
   * @see io.fixprotocol._2016.fixrepository.FixrepositoryPackage#getFieldRefType_CodeSet()
   * @model containment="true"
   *        extendedMetaData="kind='element' name='codeSet' namespace='##targetNamespace'"
   * @generated
   */
  CodeSetType getCodeSet();

  /**
   * Sets the value of the '{@link io.fixprotocol._2016.fixrepository.FieldRefType#getCodeSet <em>Code Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Code Set</em>' containment reference.
   * @see #getCodeSet()
   * @generated
   */
  void setCodeSet(CodeSetType value);
   ...
   * @see io.fixprotocol._2016.fixrepository.FixrepositoryPackage#getFieldRefType_AbbrName()
  ...
  /**
   * Sets the value of the '{@link io.fixprotocol._2016.fixrepository.FieldRefType#getAbbrName <em>Abbr Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see io.fixprotocol._2016.fixrepository.FixrepositoryPackage#getFieldRefType_Name()
  ...
  /**
   * Sets the value of the '{@link io.fixprotocol._2016.fixrepository.FieldRefType#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setOid(String)
   * @see io.fixprotocol._2016.fixrepository.FixrepositoryPackage#getFieldRefType_Oid()
  ...
  /**
   * Sets the value of the '{@link io.fixprotocol._2016.fixrepository.FieldRefType#getOid <em>Oid</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
