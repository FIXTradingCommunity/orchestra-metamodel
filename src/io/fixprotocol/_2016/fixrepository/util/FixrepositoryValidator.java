...
public class FixrepositoryValidator extends EObjectValidator {
  ...
  protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
    switch (classifierID) {
      ...
      case FixrepositoryPackage.VOLUME_NAME_T:
        return validateVolumeNameT((VolumeNameT)value, diagnostics, context);
      ...
      case FixrepositoryPackage.OID_OR_URI_T:
        return validateOidOrUriT((String)value, diagnostics, context);
      case FixrepositoryPackage.OID_T:
        return validateOidT((String)value, diagnostics, context);
      ...
      case FixrepositoryPackage.VOLUME_NAME_TOBJECT:
        return validateVolumeNameTObject((VolumeNameT)value, diagnostics, context);
      case FixrepositoryPackage.VOLUME_NUMBER_T:
        return validateVolumeNumberT((BigInteger)value, diagnostics, context);
   ...
   * @generated
   */
  public boolean validateVolumeNameT(VolumeNameT volumeNameT, DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
  ...
  public static final  PatternMatcher [][] NAME_T__PATTERN__VALUES =
    new PatternMatcher [][] {
      new PatternMatcher [] {
        XMLTypeUtil.createPatternMatcher("([A-Z]|[a-z]|_)([0-9]|[A-Z]|[a-z]|_)*")
      }
    };
   ...
   * @generated
   */
  public boolean validateOidOrUriT(String oidOrUriT, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = validateOidOrUriT_MemberTypes(oidOrUriT, diagnostics, context);
    return result;
  }

  /**
   * Validates the MemberTypes constraint of '<em>Oid Or Uri T</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateOidOrUriT_MemberTypes(String oidOrUriT, DiagnosticChain diagnostics, Map<Object, Object> context) {
    if (diagnostics != null) {
      BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
      if (XMLTypePackage.Literals.ANY_URI.isInstance(oidOrUriT)) {
        if (xmlTypeValidator.validateAnyURI(oidOrUriT, tempDiagnostics, context)) return true;
      }
      if (FixrepositoryPackage.eINSTANCE.getOidT().isInstance(oidOrUriT)) {
        if (validateOidT(oidOrUriT, tempDiagnostics, context)) return true;
      }
      for (Diagnostic diagnostic : tempDiagnostics.getChildren()) {
        diagnostics.add(diagnostic);
      }
      ...
      if (XMLTypePackage.Literals.ANY_URI.isInstance(oidOrUriT)) {
        if (xmlTypeValidator.validateAnyURI(oidOrUriT, null, context)) return true;
      }
      if (FixrepositoryPackage.eINSTANCE.getOidT().isInstance(oidOrUriT)) {
        if (validateOidT(oidOrUriT, null, context)) return true;
      }
    }
    return false;
  }
   ...
   * @generated
   */
  public boolean validateOidT(String oidT, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = validateOidT_Pattern(oidT, diagnostics, context);
    return result;
  }
   ...
   * <!-- end-user-doc -->
   * @generated
   * @see #validateOidT_Pattern
   */
  public static final  PatternMatcher [][] OID_T__PATTERN__VALUES =
    new PatternMatcher [][] {
      new PatternMatcher [] {
  ...
  /**
   * Validates the Pattern constraint of '<em>Oid T</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateOidT_Pattern(String oidT, DiagnosticChain diagnostics, Map<Object, Object> context) {
    return validatePattern(FixrepositoryPackage.eINSTANCE.getOidT(), oidT, OID_T__PATTERN__VALUES, diagnostics, context);
  }
   ...
   * @generated
   */
  public boolean validateVolumeNameTObject(VolumeNameT volumeNameTObject, DiagnosticChain diagnostics, Map<Object, Object> context) {
    return true;
  }
   ...
   * @generated
   */
  public boolean validateVolumeNumberT(BigInteger volumeNumberT, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = validateVolumeNumberT_Min(volumeNumberT, diagnostics, context);
    if (result || diagnostics != null) result &= validateVolumeNumberT_Max(volumeNumberT, diagnostics, context);
    return result;
  }
   ...
   * <!-- end-user-doc -->
   * @generated
   * @see #validateVolumeNumberT_Min
   */
  public static final BigInteger VOLUME_NUMBER_T__MIN__VALUE = new BigInteger("1");

  /**
   * Validates the Min constraint of '<em>Volume Number T</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateVolumeNumberT_Min(BigInteger volumeNumberT, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = volumeNumberT.compareTo(VOLUME_NUMBER_T__MIN__VALUE) >= 0;
    if (!result && diagnostics != null)
      reportMinViolation(FixrepositoryPackage.eINSTANCE.getVolumeNumberT(), volumeNumberT, VOLUME_NUMBER_T__MIN__VALUE, true, diagnostics, context);
    return result;
  }
   ...
   * <!-- end-user-doc -->
   * @generated
   * @see #validateVolumeNumberT_Max
   */
  public static final BigInteger VOLUME_NUMBER_T__MAX__VALUE = new BigInteger("5");

  /**
   * Validates the Max constraint of '<em>Volume Number T</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public boolean validateVolumeNumberT_Max(BigInteger volumeNumberT, DiagnosticChain diagnostics, Map<Object, Object> context) {
    boolean result = volumeNumberT.compareTo(VOLUME_NUMBER_T__MAX__VALUE) <= 0;
    if (!result && diagnostics != null)
      reportMaxViolation(FixrepositoryPackage.eINSTANCE.getVolumeNumberT(), volumeNumberT, VOLUME_NUMBER_T__MAX__VALUE, true, diagnostics, context);
    return result;
  }
