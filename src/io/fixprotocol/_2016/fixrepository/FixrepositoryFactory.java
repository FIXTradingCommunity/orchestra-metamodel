 ...
 * @generated
 */
public interface FixrepositoryFactory extends EFactory {
  /**
   ...
   * @generated
   */
  FixrepositoryFactory eINSTANCE = io.fixprotocol._2016.fixrepository.impl.FixrepositoryFactoryImpl.init();

  /**
   * Returns a new object of class '<em>Abbreviations Type</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Abbreviations Type</em>'.
   * @generated
   */
  AbbreviationsType createAbbreviationsType();
  ...
  /**
   * Returns a new object of class '<em>Mapped Datatype Type</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Mapped Datatype Type</em>'.
   * @generated
   */
  MappedDatatypeType createMappedDatatypeType();
   ...
   * @generated
   */
  FixrepositoryPackage getFixrepositoryPackage();
