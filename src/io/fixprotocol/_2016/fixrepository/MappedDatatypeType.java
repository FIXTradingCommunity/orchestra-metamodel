 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2016.fixrepository.MappedDatatypeType#getMappedDatatype <em>Mapped Datatype</em>}</li>
 *   <li>{@link io.fixprotocol._2016.fixrepository.MappedDatatypeType#getAnnotation <em>Annotation</em>}</li>
...
public interface MappedDatatypeType extends EObject {
   ...
   * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * Nesting supports composite types
   * <!-- end-model-doc -->
   * @return the value of the '<em>Mapped Datatype</em>' containment reference list.
   * @see io.fixprotocol._2016.fixrepository.FixrepositoryPackage#getMappedDatatypeType_MappedDatatype()
   ...
   * @see io.fixprotocol._2016.fixrepository.FixrepositoryPackage#getMappedDatatypeType_Annotation()
   * @model containment="true"
  ...
  /**
   * Sets the value of the '{@link io.fixprotocol._2016.fixrepository.MappedDatatypeType#getAnnotation <em>Annotation</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
