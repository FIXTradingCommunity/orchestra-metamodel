 ...
 *   <li>{@link io.fixprotocol._2016.fixrepository.RepositoryType#isHasComponents <em>Has Components</em>}</li>
...
public interface RepositoryType extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Has Components</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Has Components</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Has Components</em>' attribute.
   * @see #isSetHasComponents()
   * @see #unsetHasComponents()
   * @see #setHasComponents(boolean)
   * @see io.fixprotocol._2016.fixrepository.FixrepositoryPackage#getRepositoryType_HasComponents()
   * @model unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.Boolean" required="true"
   *        extendedMetaData="kind='attribute' name='hasComponents'"
   * @generated
   */
  boolean isHasComponents();

  /**
   * Sets the value of the '{@link io.fixprotocol._2016.fixrepository.RepositoryType#isHasComponents <em>Has Components</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Has Components</em>' attribute.
   * @see #isSetHasComponents()
   * @see #unsetHasComponents()
   * @see #isHasComponents()
   * @generated
   */
  void setHasComponents(boolean value);

  /**
   * Unsets the value of the '{@link io.fixprotocol._2016.fixrepository.RepositoryType#isHasComponents <em>Has Components</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #isSetHasComponents()
   * @see #isHasComponents()
   ...
   * @generated
   */
  void unsetHasComponents();

  /**
   * Returns whether the value of the '{@link io.fixprotocol._2016.fixrepository.RepositoryType#isHasComponents <em>Has Components</em>}' attribute is set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return whether the value of the '<em>Has Components</em>' attribute is set.
   * @see #unsetHasComponents()
   * @see #isHasComponents()
   * @see #setHasComponents(boolean)
   * @generated
   */
  boolean isSetHasComponents();
