...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Code Set Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getCode <em>Code</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getAbbrName <em>Abbr Name</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getAdded <em>Added</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getAddedEP <em>Added EP</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getChangeType <em>Change Type</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getDeprecated <em>Deprecated</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getDeprecatedEP <em>Deprecated EP</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getIssue <em>Issue</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getLastModified <em>Last Modified</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getReplaced <em>Replaced</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getReplacedByField <em>Replaced By Field</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getReplacedEP <em>Replaced EP</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getScenario <em>Scenario</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getSpecUrl <em>Spec Url</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getSupported <em>Supported</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getUpdated <em>Updated</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.CodeSetTypeImpl#getUpdatedEP <em>Updated EP</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CodeSetTypeImpl extends MinimalEObjectImpl.Container implements CodeSetType {
  /**
  ...
  protected EClass eStaticClass() {
    return RepositoryPackage.eINSTANCE.getCodeSetType();
  }
  ...
  public EList<CodeType> getCode() {
    if (code == null) {
      code = new EObjectContainmentEList<CodeType>(CodeType.class, this, RepositoryPackage.CODE_SET_TYPE__CODE);
    }
    return code;
  }
  ...
  public NotificationChain basicSetAnnotation(Annotation newAnnotation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__ANNOTATION, oldAnnotation, newAnnotation);
  ...
  public void setAnnotation(Annotation newAnnotation) {
    if (newAnnotation != annotation) {
      ...
      if (annotation != null)
        msgs = ((InternalEObject)annotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RepositoryPackage.CODE_SET_TYPE__ANNOTATION, null, msgs);
      if (newAnnotation != null)
        msgs = ((InternalEObject)newAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RepositoryPackage.CODE_SET_TYPE__ANNOTATION, null, msgs);
      msgs = basicSetAnnotation(newAnnotation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__ANNOTATION, newAnnotation, newAnnotation));
  }
  ...
  public void setAbbrName(String newAbbrName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__ABBR_NAME, oldAbbrName, abbrName));
  }
  ...
  public void setAdded(String newAdded) {
    ...
    added = newAdded;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__ADDED, oldAdded, added));
  }
  ...
  public void setAddedEP(BigInteger newAddedEP) {
    ...
    addedEP = newAddedEP;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__ADDED_EP, oldAddedEP, addedEP));
  }
  ...
  public void setChangeType(ChangeTypeT newChangeType) {
    ...
    changeTypeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__CHANGE_TYPE, oldChangeType, changeType, !oldChangeTypeESet));
  }
  ...
  public void unsetChangeType() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.CODE_SET_TYPE__CHANGE_TYPE, oldChangeType, CHANGE_TYPE_EDEFAULT, oldChangeTypeESet));
  }
  ...
  public void setDefault(String newDefault) {
    ...
    default_ = newDefault;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__DEFAULT, oldDefault, default_));
  }
  ...
  public void setDeprecated(String newDeprecated) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__DEPRECATED, oldDeprecated, deprecated));
  }
  ...
  public void setDeprecatedEP(BigInteger newDeprecatedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__DEPRECATED_EP, oldDeprecatedEP, deprecatedEP));
  }
  ...
  public void setId(BigInteger newId) {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__ID, oldId, id));
  }
  ...
  public void setIssue(String newIssue) {
    ...
    issue = newIssue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__ISSUE, oldIssue, issue));
  }
  ...
  public void setLastModified(String newLastModified) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__LAST_MODIFIED, oldLastModified, lastModified));
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__NAME, oldName, name));
  }
  ...
  public void setReplaced(String newReplaced) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__REPLACED, oldReplaced, replaced));
  }
  ...
  public void setReplacedByField(BigInteger newReplacedByField) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__REPLACED_BY_FIELD, oldReplacedByField, replacedByField));
  }
  ...
  public void setReplacedEP(BigInteger newReplacedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__REPLACED_EP, oldReplacedEP, replacedEP));
  }
  ...
  public void setScenario(String newScenario) {
    ...
    scenarioESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__SCENARIO, oldScenario, scenario, !oldScenarioESet));
  }
  ...
  public void unsetScenario() {
    ...
    scenarioESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.CODE_SET_TYPE__SCENARIO, oldScenario, SCENARIO_EDEFAULT, oldScenarioESet));
  }
  ...
  public void setSpecUrl(String newSpecUrl) {
    ...
    specUrl = newSpecUrl;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__SPEC_URL, oldSpecUrl, specUrl));
  }
  ...
  public void setSupported(SupportType newSupported) {
    ...
    supportedESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__SUPPORTED, oldSupported, supported, !oldSupportedESet));
  }
  ...
  public void unsetSupported() {
    ...
    supportedESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.CODE_SET_TYPE__SUPPORTED, oldSupported, SUPPORTED_EDEFAULT, oldSupportedESet));
  }
  ...
  public void setType(String newType) {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__TYPE, oldType, type));
  }
  ...
  public void setUpdated(String newUpdated) {
    ...
    updated = newUpdated;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__UPDATED, oldUpdated, updated));
  }
  ...
  public void setUpdatedEP(BigInteger newUpdatedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.CODE_SET_TYPE__UPDATED_EP, oldUpdatedEP, updatedEP));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case RepositoryPackage.CODE_SET_TYPE__CODE:
        return ((InternalEList<?>)getCode()).basicRemove(otherEnd, msgs);
      case RepositoryPackage.CODE_SET_TYPE__ANNOTATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case RepositoryPackage.CODE_SET_TYPE__ABBR_NAME:
        return getAbbrName();
      case RepositoryPackage.CODE_SET_TYPE__ADDED:
        return getAdded();
      case RepositoryPackage.CODE_SET_TYPE__ADDED_EP:
        return getAddedEP();
      case RepositoryPackage.CODE_SET_TYPE__CHANGE_TYPE:
        return getChangeType();
      case RepositoryPackage.CODE_SET_TYPE__DEFAULT:
        return getDefault();
      case RepositoryPackage.CODE_SET_TYPE__DEPRECATED:
        return getDeprecated();
      case RepositoryPackage.CODE_SET_TYPE__DEPRECATED_EP:
        return getDeprecatedEP();
      case RepositoryPackage.CODE_SET_TYPE__ID:
        return getId();
      case RepositoryPackage.CODE_SET_TYPE__ISSUE:
        return getIssue();
      case RepositoryPackage.CODE_SET_TYPE__LAST_MODIFIED:
        return getLastModified();
      case RepositoryPackage.CODE_SET_TYPE__NAME:
        return getName();
      case RepositoryPackage.CODE_SET_TYPE__REPLACED:
        return getReplaced();
      case RepositoryPackage.CODE_SET_TYPE__REPLACED_BY_FIELD:
        return getReplacedByField();
      case RepositoryPackage.CODE_SET_TYPE__REPLACED_EP:
        return getReplacedEP();
      case RepositoryPackage.CODE_SET_TYPE__SCENARIO:
        return getScenario();
      case RepositoryPackage.CODE_SET_TYPE__SPEC_URL:
        return getSpecUrl();
      case RepositoryPackage.CODE_SET_TYPE__SUPPORTED:
        return getSupported();
      case RepositoryPackage.CODE_SET_TYPE__TYPE:
        return getType();
      case RepositoryPackage.CODE_SET_TYPE__UPDATED:
        return getUpdated();
      case RepositoryPackage.CODE_SET_TYPE__UPDATED_EP:
        return getUpdatedEP();
    }
