 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.ComponentsTypeImpl#getComponent <em>Component</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.ComponentsTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.ComponentsTypeImpl#getLatestEP <em>Latest EP</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentsTypeImpl extends MinimalEObjectImpl.Container implements ComponentsType {
  ...
  protected EClass eStaticClass() {
    return RepositoryPackage.eINSTANCE.getComponentsType();
  }
  ...
  public EList<ComponentType> getComponent() {
    if (component == null) {
      component = new EObjectContainmentEList<ComponentType>(ComponentType.class, this, RepositoryPackage.COMPONENTS_TYPE__COMPONENT);
    }
    return component;
  }
  ...
  public void setBase(String newBase) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.COMPONENTS_TYPE__BASE, oldBase, base));
  }
  ...
  public void setLatestEP(BigInteger newLatestEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.COMPONENTS_TYPE__LATEST_EP, oldLatestEP, latestEP));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case RepositoryPackage.COMPONENTS_TYPE__COMPONENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case RepositoryPackage.COMPONENTS_TYPE__COMPONENT:
        return getComponent();
      case RepositoryPackage.COMPONENTS_TYPE__BASE:
        return getBase();
      case RepositoryPackage.COMPONENTS_TYPE__LATEST_EP:
        return getLatestEP();
    }
