 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getUnique <em>Unique</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getAssign <em>Assign</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getWhen <em>When</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getImplLength <em>Impl Length</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getImplMaxLength <em>Impl Max Length</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getImplMinLength <em>Impl Min Length</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getPresence <em>Presence</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getRendering <em>Rendering</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldRuleTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldRuleTypeImpl extends MinimalEObjectImpl.Container implements FieldRuleType {
  ...
  protected EClass eStaticClass() {
    return RepositoryPackage.eINSTANCE.getFieldRuleType();
  }
  ...
  public NotificationChain basicSetUnique(UniqueType newUnique, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__UNIQUE, oldUnique, newUnique);
  ...
  public void setUnique(UniqueType newUnique) {
    if (newUnique != unique) {
      ...
      if (unique != null)
        msgs = ((InternalEObject)unique).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RepositoryPackage.FIELD_RULE_TYPE__UNIQUE, null, msgs);
      if (newUnique != null)
        msgs = ((InternalEObject)newUnique).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RepositoryPackage.FIELD_RULE_TYPE__UNIQUE, null, msgs);
      msgs = basicSetUnique(newUnique, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__UNIQUE, newUnique, newUnique));
  }
  ...
  public EList<String> getAssign() {
    if (assign == null) {
      assign = new EDataTypeEList<String>(String.class, this, RepositoryPackage.FIELD_RULE_TYPE__ASSIGN);
    }
    return assign;
  }
  ...
  public void setWhen(String newWhen) {
    ...
    when = newWhen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__WHEN, oldWhen, when));
  }
  ...
  public void setEncoding(String newEncoding) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__ENCODING, oldEncoding, encoding));
  }
  ...
  public void setImplLength(short newImplLength) {
    ...
    implLengthESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__IMPL_LENGTH, oldImplLength, implLength, !oldImplLengthESet));
  }
  ...
  public void unsetImplLength() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.FIELD_RULE_TYPE__IMPL_LENGTH, oldImplLength, IMPL_LENGTH_EDEFAULT, oldImplLengthESet));
  }
  ...
  public void setImplMaxLength(short newImplMaxLength) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__IMPL_MAX_LENGTH, oldImplMaxLength, implMaxLength, !oldImplMaxLengthESet));
  }
  ...
  public void unsetImplMaxLength() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.FIELD_RULE_TYPE__IMPL_MAX_LENGTH, oldImplMaxLength, IMPL_MAX_LENGTH_EDEFAULT, oldImplMaxLengthESet));
  }
  ...
  public void setImplMinLength(short newImplMinLength) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__IMPL_MIN_LENGTH, oldImplMinLength, implMinLength, !oldImplMinLengthESet));
  }
  ...
  public void unsetImplMinLength() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.FIELD_RULE_TYPE__IMPL_MIN_LENGTH, oldImplMinLength, IMPL_MIN_LENGTH_EDEFAULT, oldImplMinLengthESet));
  }
  ...
  public void setMaxInclusive(String newMaxInclusive) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__MAX_INCLUSIVE, oldMaxInclusive, maxInclusive));
  }
  ...
  public void setMinInclusive(String newMinInclusive) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__MIN_INCLUSIVE, oldMinInclusive, minInclusive));
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__NAME, oldName, name));
  }
  ...
  public void setPresence(PresenceT newPresence) {
    ...
    presenceESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__PRESENCE, oldPresence, presence, !oldPresenceESet));
  }
  ...
  public void unsetPresence() {
    ...
    presenceESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.FIELD_RULE_TYPE__PRESENCE, oldPresence, PRESENCE_EDEFAULT, oldPresenceESet));
  }
  ...
  public void setRendering(String newRendering) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__RENDERING, oldRendering, rendering));
  }
  ...
  public void setType(String newType) {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__TYPE, oldType, type));
  }
  ...
  public void setValue(String newValue) {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELD_RULE_TYPE__VALUE, oldValue, value));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case RepositoryPackage.FIELD_RULE_TYPE__UNIQUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case RepositoryPackage.FIELD_RULE_TYPE__UNIQUE:
        return getUnique();
      case RepositoryPackage.FIELD_RULE_TYPE__ASSIGN:
        return getAssign();
      case RepositoryPackage.FIELD_RULE_TYPE__WHEN:
        return getWhen();
      case RepositoryPackage.FIELD_RULE_TYPE__ENCODING:
        return getEncoding();
      case RepositoryPackage.FIELD_RULE_TYPE__IMPL_LENGTH:
        return getImplLength();
      case RepositoryPackage.FIELD_RULE_TYPE__IMPL_MAX_LENGTH:
        return getImplMaxLength();
      case RepositoryPackage.FIELD_RULE_TYPE__IMPL_MIN_LENGTH:
        return getImplMinLength();
      case RepositoryPackage.FIELD_RULE_TYPE__MAX_INCLUSIVE:
        return getMaxInclusive();
      case RepositoryPackage.FIELD_RULE_TYPE__MIN_INCLUSIVE:
        return getMinInclusive();
      case RepositoryPackage.FIELD_RULE_TYPE__NAME:
        return getName();
      case RepositoryPackage.FIELD_RULE_TYPE__PRESENCE:
        return getPresence();
      case RepositoryPackage.FIELD_RULE_TYPE__RENDERING:
        return getRendering();
      case RepositoryPackage.FIELD_RULE_TYPE__TYPE:
        return getType();
      case RepositoryPackage.FIELD_RULE_TYPE__VALUE:
        return getValue();
    }
