 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getNumInGroup <em>Num In Group</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getComponentRef <em>Component Ref</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getGroupRef <em>Group Ref</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getFieldRef <em>Field Ref</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getAbbrName <em>Abbr Name</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getAdded <em>Added</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getAddedEP <em>Added EP</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getChangeType <em>Change Type</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getDeprecated <em>Deprecated</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getDeprecatedEP <em>Deprecated EP</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getImplMaxOccurs <em>Impl Max Occurs</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getImplMinOccurs <em>Impl Min Occurs</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getIssue <em>Issue</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getLastModified <em>Last Modified</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getRendering <em>Rendering</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getReplaced <em>Replaced</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getReplacedByField <em>Replaced By Field</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getReplacedEP <em>Replaced EP</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getScenario <em>Scenario</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getSupported <em>Supported</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getUpdated <em>Updated</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getUpdatedEP <em>Updated EP</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.GroupTypeImpl#getWhich <em>Which</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupTypeImpl extends MinimalEObjectImpl.Container implements GroupType {
  ...
  protected EClass eStaticClass() {
    return RepositoryPackage.eINSTANCE.getGroupType();
  }
  ...
  public NotificationChain basicSetNumInGroup(FieldRefType newNumInGroup, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__NUM_IN_GROUP, oldNumInGroup, newNumInGroup);
  ...
  public void setNumInGroup(FieldRefType newNumInGroup) {
    if (newNumInGroup != numInGroup) {
      ...
      if (numInGroup != null)
        msgs = ((InternalEObject)numInGroup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RepositoryPackage.GROUP_TYPE__NUM_IN_GROUP, null, msgs);
      if (newNumInGroup != null)
        msgs = ((InternalEObject)newNumInGroup).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RepositoryPackage.GROUP_TYPE__NUM_IN_GROUP, null, msgs);
      msgs = basicSetNumInGroup(newNumInGroup, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__NUM_IN_GROUP, newNumInGroup, newNumInGroup));
  }
  ...
  public FeatureMap getGroup() {
    if (group == null) {
      group = new BasicFeatureMap(this, RepositoryPackage.GROUP_TYPE__GROUP);
    }
    return group;
  }
  ...
  public EList<ComponentRefType> getComponentRef() {
    return getGroup().list(RepositoryPackage.eINSTANCE.getGroupType_ComponentRef());
  }
  ...
  public EList<GroupRefType> getGroupRef() {
    return getGroup().list(RepositoryPackage.eINSTANCE.getGroupType_GroupRef());
  }
  ...
  public EList<FieldRefType> getFieldRef() {
    return getGroup().list(RepositoryPackage.eINSTANCE.getGroupType_FieldRef());
  }
  ...
  public NotificationChain basicSetAnnotation(Annotation newAnnotation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__ANNOTATION, oldAnnotation, newAnnotation);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAnnotation(Annotation newAnnotation) {
    if (newAnnotation != annotation) {
      NotificationChain msgs = null;
      if (annotation != null)
        msgs = ((InternalEObject)annotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RepositoryPackage.GROUP_TYPE__ANNOTATION, null, msgs);
      if (newAnnotation != null)
        msgs = ((InternalEObject)newAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RepositoryPackage.GROUP_TYPE__ANNOTATION, null, msgs);
      msgs = basicSetAnnotation(newAnnotation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__ANNOTATION, newAnnotation, newAnnotation));
  }
  ...
  public void setAbbrName(String newAbbrName) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__ABBR_NAME, oldAbbrName, abbrName));
  }
  ...
  public void setAdded(String newAdded) {
    ...
    added = newAdded;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__ADDED, oldAdded, added));
  }
  ...
  public void setAddedEP(BigInteger newAddedEP) {
    ...
    addedEP = newAddedEP;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__ADDED_EP, oldAddedEP, addedEP));
  }
  ...
  public void setCategory(String newCategory) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__CATEGORY, oldCategory, category));
  }
  ...
  public void setChangeType(ChangeTypeT newChangeType) {
    ...
    changeTypeESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__CHANGE_TYPE, oldChangeType, changeType, !oldChangeTypeESet));
  }
  ...
  public void unsetChangeType() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.GROUP_TYPE__CHANGE_TYPE, oldChangeType, CHANGE_TYPE_EDEFAULT, oldChangeTypeESet));
  }
  ...
  public void setDeprecated(String newDeprecated) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__DEPRECATED, oldDeprecated, deprecated));
  }
  ...
  public void setDeprecatedEP(BigInteger newDeprecatedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__DEPRECATED_EP, oldDeprecatedEP, deprecatedEP));
  }
  ...
  public void setId(BigInteger newId) {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__ID, oldId, id));
  }
  ...
  public void setImplMaxOccurs(Object newImplMaxOccurs) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__IMPL_MAX_OCCURS, oldImplMaxOccurs, implMaxOccurs, !oldImplMaxOccursESet));
  }
  ...
  public void unsetImplMaxOccurs() {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.GROUP_TYPE__IMPL_MAX_OCCURS, oldImplMaxOccurs, IMPL_MAX_OCCURS_EDEFAULT, oldImplMaxOccursESet));
  }
  ...
  public void setImplMinOccurs(BigInteger newImplMinOccurs) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__IMPL_MIN_OCCURS, oldImplMinOccurs, implMinOccurs));
  }
  ...
  public void setIssue(String newIssue) {
    ...
    issue = newIssue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__ISSUE, oldIssue, issue));
  }
  ...
  public void setLastModified(String newLastModified) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__LAST_MODIFIED, oldLastModified, lastModified));
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__NAME, oldName, name));
  }
  ...
  public void setRendering(String newRendering) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__RENDERING, oldRendering, rendering));
  }
  ...
  public void setReplaced(String newReplaced) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__REPLACED, oldReplaced, replaced));
  }
  ...
  public void setReplacedByField(BigInteger newReplacedByField) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__REPLACED_BY_FIELD, oldReplacedByField, replacedByField));
  }
  ...
  public void setReplacedEP(BigInteger newReplacedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__REPLACED_EP, oldReplacedEP, replacedEP));
  }
  ...
  public void setScenario(String newScenario) {
    ...
    scenarioESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__SCENARIO, oldScenario, scenario, !oldScenarioESet));
  }
  ...
  public void unsetScenario() {
    ...
    scenarioESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.GROUP_TYPE__SCENARIO, oldScenario, SCENARIO_EDEFAULT, oldScenarioESet));
  }
  ...
  public void setSupported(SupportType newSupported) {
    ...
    supportedESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__SUPPORTED, oldSupported, supported, !oldSupportedESet));
  }
  ...
  public void unsetSupported() {
    ...
    supportedESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.GROUP_TYPE__SUPPORTED, oldSupported, SUPPORTED_EDEFAULT, oldSupportedESet));
  }
  ...
  public void setUpdated(String newUpdated) {
    ...
    updated = newUpdated;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__UPDATED, oldUpdated, updated));
  }
  ...
  public void setUpdatedEP(BigInteger newUpdatedEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__UPDATED_EP, oldUpdatedEP, updatedEP));
  }
  ...
  public void setWhich(MemberType newWhich) {
    ...
    whichESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.GROUP_TYPE__WHICH, oldWhich, which, !oldWhichESet));
  }
  ...
  public void unsetWhich() {
    ...
    whichESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, RepositoryPackage.GROUP_TYPE__WHICH, oldWhich, WHICH_EDEFAULT, oldWhichESet));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case RepositoryPackage.GROUP_TYPE__NUM_IN_GROUP:
        return basicSetNumInGroup(null, msgs);
      case RepositoryPackage.GROUP_TYPE__GROUP:
        return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
      case RepositoryPackage.GROUP_TYPE__COMPONENT_REF:
        return ((InternalEList<?>)getComponentRef()).basicRemove(otherEnd, msgs);
      case RepositoryPackage.GROUP_TYPE__GROUP_REF:
        return ((InternalEList<?>)getGroupRef()).basicRemove(otherEnd, msgs);
      case RepositoryPackage.GROUP_TYPE__FIELD_REF:
        return ((InternalEList<?>)getFieldRef()).basicRemove(otherEnd, msgs);
      case RepositoryPackage.GROUP_TYPE__ANNOTATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      ...
      case RepositoryPackage.GROUP_TYPE__ABBR_NAME:
        return getAbbrName();
      case RepositoryPackage.GROUP_TYPE__ADDED:
        return getAdded();
      case RepositoryPackage.GROUP_TYPE__ADDED_EP:
        return getAddedEP();
      case RepositoryPackage.GROUP_TYPE__CATEGORY:
        return getCategory();
      case RepositoryPackage.GROUP_TYPE__CHANGE_TYPE:
        return getChangeType();
      case RepositoryPackage.GROUP_TYPE__DEPRECATED:
        return getDeprecated();
      case RepositoryPackage.GROUP_TYPE__DEPRECATED_EP:
        return getDeprecatedEP();
      case RepositoryPackage.GROUP_TYPE__ID:
        return getId();
      case RepositoryPackage.GROUP_TYPE__IMPL_MAX_OCCURS:
        return getImplMaxOccurs();
      case RepositoryPackage.GROUP_TYPE__IMPL_MIN_OCCURS:
        return getImplMinOccurs();
      case RepositoryPackage.GROUP_TYPE__ISSUE:
        return getIssue();
      case RepositoryPackage.GROUP_TYPE__LAST_MODIFIED:
        return getLastModified();
      case RepositoryPackage.GROUP_TYPE__NAME:
        return getName();
      case RepositoryPackage.GROUP_TYPE__RENDERING:
        return getRendering();
      case RepositoryPackage.GROUP_TYPE__REPLACED:
        return getReplaced();
      case RepositoryPackage.GROUP_TYPE__REPLACED_BY_FIELD:
        return getReplacedByField();
      case RepositoryPackage.GROUP_TYPE__REPLACED_EP:
        return getReplacedEP();
      case RepositoryPackage.GROUP_TYPE__SCENARIO:
        return getScenario();
      case RepositoryPackage.GROUP_TYPE__SUPPORTED:
        return getSupported();
      case RepositoryPackage.GROUP_TYPE__UPDATED:
        return getUpdated();
      case RepositoryPackage.GROUP_TYPE__UPDATED_EP:
        return getUpdatedEP();
      case RepositoryPackage.GROUP_TYPE__WHICH:
        return getWhich();
    }
