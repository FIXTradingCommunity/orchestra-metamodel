 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldsTypeImpl#getField <em>Field</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldsTypeImpl#getBase <em>Base</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.FieldsTypeImpl#getLatestEP <em>Latest EP</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldsTypeImpl extends MinimalEObjectImpl.Container implements FieldsType {
  ...
  protected EClass eStaticClass() {
    return RepositoryPackage.eINSTANCE.getFieldsType();
  }
  ...
  public EList<FieldType> getField() {
    if (field == null) {
      field = new EObjectContainmentEList<FieldType>(FieldType.class, this, RepositoryPackage.FIELDS_TYPE__FIELD);
    }
    return field;
  }
  ...
  public void setBase(String newBase) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELDS_TYPE__BASE, oldBase, base));
  }
  ...
  public void setLatestEP(BigInteger newLatestEP) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.FIELDS_TYPE__LATEST_EP, oldLatestEP, latestEP));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case RepositoryPackage.FIELDS_TYPE__FIELD:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case RepositoryPackage.FIELDS_TYPE__FIELD:
        return getField();
      case RepositoryPackage.FIELDS_TYPE__BASE:
        return getBase();
      case RepositoryPackage.FIELDS_TYPE__LATEST_EP:
        return getLatestEP();
    }
