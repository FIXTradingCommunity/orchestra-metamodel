 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.TriggerTypeImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.TriggerTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.TriggerTypeImpl#getStateMachine <em>State Machine</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TriggerTypeImpl extends MinimalEObjectImpl.Container implements TriggerType {
  ...
  protected EClass eStaticClass() {
    return RepositoryPackage.eINSTANCE.getTriggerType();
  }
  ...
  public void setActor(String newActor) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.TRIGGER_TYPE__ACTOR, oldActor, actor));
  }
  ...
  public void setName(String newName) {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.TRIGGER_TYPE__NAME, oldName, name));
  }
  ...
  public void setStateMachine(String newStateMachine) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.TRIGGER_TYPE__STATE_MACHINE, oldStateMachine, stateMachine));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case RepositoryPackage.TRIGGER_TYPE__ACTOR:
        return getActor();
      case RepositoryPackage.TRIGGER_TYPE__NAME:
        return getName();
      case RepositoryPackage.TRIGGER_TYPE__STATE_MACHINE:
