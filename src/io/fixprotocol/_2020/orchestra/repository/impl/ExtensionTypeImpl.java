 ...
 * </p>
 * <ul>
 *   <li>{@link io.fixprotocol._2020.orchestra.repository.impl.ExtensionTypeImpl#getAny <em>Any</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtensionTypeImpl extends MinimalEObjectImpl.Container implements ExtensionType {
  ...
  protected EClass eStaticClass() {
    return RepositoryPackage.eINSTANCE.getExtensionType();
  }
  ...
  public FeatureMap getAny() {
    if (any == null) {
      any = new BasicFeatureMap(this, RepositoryPackage.EXTENSION_TYPE__ANY);
    }
    return any;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case RepositoryPackage.EXTENSION_TYPE__ANY:
